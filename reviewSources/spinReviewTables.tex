...
\separate{
After these preliminaries, we will now present the spin-qubit figures of merit published until \recheck{the middle of year 2022}.
}
...
\begin{figure}
  ...
  \includegraphics[width=0.89\linewidth]{plot-spinCoherence-Type-5.pdf}
  \caption{
